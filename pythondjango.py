...
def setup_install():
  ...
  os.system('chow -R yalixue468 /opt/django')    # we're useing shell, because the python builtin chown doesn't work as well

 def django_install():
   print('ativating virtualenv and installing django after pre-requirements have been met') # You must activate the virtualenv shell every time
