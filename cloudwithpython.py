...
def create_instance(compute,project,zone,name):
    ...
    image_response = compute.images().getFromFamily(
      ...
      souce_disk_image = image_response['selfLink']
      ...
      config = {
          ...
          # specify the boot disk and the image to use as a souce.
          'disks':[
              {
                  'boot':True,
                  'autoDelete':True
           ...
           'networkInterfaces': [{
            ...
            # Allow the instance to access cloud storage and loggine.
            'serviceAccounts': [{
                'email': 'default',
                'scopes': [
 ...
 newinstance = create_instance(compte, projrct, zone, name)
